...
public class AESUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //移动端随机key  AES加密数据
       String enr= encrypt("{'mobile':'17805056119','code':'6666','platform':'android','channelId':'123456'}",okey);
       System.out.println(enr);
       //移动端RSA加密AES的key 和加密的数据一起传到服务器
       byte[] keyrsa = RSAUtil.encryptByPublicKey(okey.getBytes("UTF-8"),"MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCHVIgyK7ip5iHhCVWF0I5i eESPvJCk96pIDvTKC+9LzybQqYvanDo96XxpI8B1aDHxhKF8rtRnRxJFBhl0 k58682XdOVTRtY8lYJrHQOIrWHqIahFoKdbfH3yH7cOw3Ny6XaRgL3atHS7U 8cGEtzf9wSG8gpi3w5IleOKwcRTjvwIDAQAB");
